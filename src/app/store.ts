...
import {RegisterActionType, registerReducer} from '../features/registration/register-reducer';
...
type AppRootActionsType = AppActionType | AuthActionsType | RegisterActionType
