...
export const EyeOnOff = (props: EyeOnOffPropsType) => {
    ...
    switch (props.onOff) {
        case false: {
            return <svg width="20px" height="20px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 612 612"
        ...
        case true: {
            return <svg width="20px" height="20px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
                        className={props.className} onClick={props.onClick}>
                <path
